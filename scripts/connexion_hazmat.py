...
def run_script(driver):
    ...
    # Clique em SYSTEME CLE
    WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "/html/body/form/div[3]/table/tbody/tr/td[2]/table/tbody/tr[2]/td[1]/div[1]/ul/li[2]/a/img"))
    ).click()

    # Clique em SQUIPMENTS
    WebDriverWait(driver, 10).until(
        EC.element_to_be_clickable((By.XPATH, "/html/body/form/div[3]/table/tbody/tr/td[2]/table/tbody/tr[2]/td[1]/div[1]/ul/li[2]/ul/li[1]/a/img"))
    ).click()
    ...
    driver.find_element(By.XPATH, "/html/body/form/table/tbody/tr/td[2]/table/tbody/tr[2]/td[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[3]/td[2]/input[1]").send_keys("C3 test Zenha")
    driver.find_element(By.XPATH, "/html/body/form/table/tbody/tr/td[2]/table/tbody/tr[2]/td[2]/div/div[1]/div[2]/div[1]/table/tbody/tr[5]/td[2]/input[1]").send_keys("C4")
